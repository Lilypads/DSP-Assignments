...
for Case in range (2):
    ...
    # if Case == 0:
    #     pyplot.savefig('hr_fig1.svg', format='svg')
    # if Case == 1:
    #     pyplot.savefig('hr_fig9.svg', format='svg')
    ...
    pyplot.ylabel('Amplitude')
    # if Case == 0:
    #     pyplot.savefig('hr_fig2.svg', format='svg')
    # if Case == 1:
    #     pyplot.savefig('hr_fig10.svg', format='svg')
    ...
    pyplot.ylabel('Amplitude')
    # if Case == 0:
    #     pyplot.savefig('hr_fig3.svg', format='svg')
    # if Case == 1:
    #     pyplot.savefig('hr_fig11.svg', format='svg')
    ...
    pyplot.ylabel('Amplitude')
    # if Case == 0:
    #     pyplot.savefig('hr_fig4.svg', format='svg')
    # if Case == 1:
    #     pyplot.savefig('hr_fig12.svg', format='svg')
    ...
    pyplot.ylabel('Amplitude')
    # if Case == 0:
    #     pyplot.savefig('hr_fig5.svg', format='svg')
    # if Case == 1:
    #     pyplot.savefig('hr_fig13.svg', format='svg')
    ...
    # if Case == 0:
    #     pyplot.savefig('hr_fig6.svg', format='svg')
    # if Case == 1:
    #     pyplot.savefig('hr_fig14.svg', format='svg')
    ...
    #pyplot.xlim(3,120)         #to delete the first part where the buffer is being filled/diagnosis purpose
    # if Case == 0:
    #     pyplot.savefig('hr_fig7.svg', format='svg')
    # if Case == 1:
    #     pyplot.savefig('hr_fig15.svg', format='svg')
    ...
    # if Case == 0:
    #     pyplot.savefig('hr_fig8.svg', format='svg')
    # if Case == 1:
    #     pyplot.savefig('hr_fig16.svg', format='svg')
